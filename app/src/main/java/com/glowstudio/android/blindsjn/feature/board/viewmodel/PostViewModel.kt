...
class PostViewModel : ViewModel() {
     ...
     * 상태 메시지를 업데이트합니다.
     *
     * @param message UI에 표시할 새로운 상태 메시지
     */
    ...
    /**
     * 서버에서 게시글 목록을 비동기적으로 불러와 상태를 갱신합니다.
     *
     * 네트워크 요청이 성공하면 게시글 목록 상태를 업데이트하며,
    ...
    /**
     * 지정한 ID의 게시글을 비동기적으로 조회하여 상태를 업데이트합니다.
     *
     ...
     * 새로운 게시글을 생성하여 저장합니다.
     *
     * 게시글 저장이 성공하면 상태 메시지를 갱신하고 게시글 목록을 다시 불러옵니다.
     * 실패하거나 예외가 발생하면 상태 메시지에 오류 내용을 설정합니다.
     *
     * @param title 게시글 제목
