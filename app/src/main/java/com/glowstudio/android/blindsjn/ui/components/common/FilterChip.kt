...
/**
 * 선택 여부에 따라 스타일이 달라지는 텍스트 라벨 칩 UI 컴포넌트를 표시합니다.
 *
 * @param text 칩에 표시할 텍스트 라벨입니다.
 ...
 *
 * 앱 테마가 적용된 환경에서 "선택됨" 텍스트와 선택된 상태로 FilterChip을 렌더링합니다.
 */
...
/**
 * 선택되지 않은 상태의 FilterChip 컴포넌트 미리보기를 표시합니다.
 *
 * 앱 테마가 적용된 환경에서 "선택안됨" 레이블과 비선택 상태로 FilterChip을 렌더링합니다.
 */
@Preview(showBackground = true)
@Composable
