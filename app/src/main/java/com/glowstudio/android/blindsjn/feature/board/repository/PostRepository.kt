...
object PostRepository {
    ...
    /**
     * 모든 게시글 목록을 서버에서 비동기적으로 불러옵니다.
     *
     * @return 게시글 목록 정보를 담은 [Response].
     */
    ...
    /**
     * 지정된 게시글 ID에 해당하는 게시글의 상세 정보를 조회합니다.
     *
     ...
     *
     * @param request 수정할 게시글의 정보를 담은 요청 객체
     * @return 수정 결과에 대한 기본 응답
     */
