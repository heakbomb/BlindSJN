...
/**
 * 사업자 인증 정보를 입력받는 화면을 표시합니다.
 *
 * 사용자는 전화번호, 사업자 인증번호, 업종을 입력 및 선택할 수 있으며, '인증' 버튼을 통해 입력된 정보를 확인 콜백으로 전달합니다.
 *
 * @param navController 화면 간 내비게이션을 위한 컨트롤러입니다.
 * @param onConfirm 사용자가 인증 버튼을 눌렀을 때 입력된 전화번호, 인증번호, 업종을 전달하는 콜백입니다.
 */
@Composable
