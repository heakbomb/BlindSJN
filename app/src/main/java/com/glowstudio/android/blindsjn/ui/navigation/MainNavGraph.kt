 ...
 *
 * 홈 화면과 뉴스 상세 화면을 포함하며, 게시판, 인기글, 메시지, 프로필에 대한 하위 네비게이션 그래프를 통합합니다.
 * 뉴스 상세 화면에서는 전달받은 JSON 문자열을 디코딩 및 파싱하여 Article 객체로 변환 후 상세 정보를 표시합니다.
 */
...
/**
 * 게시판 관련 화면의 네비게이션 그래프를 정의합니다.
 *
 * 게시판 목록, 게시글 상세, 게시글 작성, 개별 게시글 상세 화면을 포함하며,
 ...
 *
 * "popular_list_screen"을 시작 지점으로 하여 인기 게시글 목록 화면을 표시하며, 상단 바를 메인 바로 설정합니다.
 */
 ...
 *
 * "calendar_screen"에서 메시지(일정) 화면을 시작하며, "add_schedule_screen"에서 일정 추가 화면으로 이동할 수 있습니다.
 * 각 화면 진입 시 상단 바 상태가 적절히 설정됩니다.
 */
 ...
 * 각 화면 진입 시 상단 바 상태를 적절히 설정하고, 화면 간 이동 및 로그아웃, 인증, 수정 완료 등의 동작을 처리합니다.
 */
